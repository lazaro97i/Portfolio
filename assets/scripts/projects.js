...
const projects = [
  ...
  },
  {
    ...
    technologies: ["Java", "Spring-Boot", "JavaScript", "React", "MySQL"],
    category: "ABM",
    description: "Sistema de gestión de usuarios, un proyecto diseñado con tecnologías avanzadas para ofrecer una solución robusta y eficiente. Desarrollado con Spring Boot para construir un backend eficiente que gestiona la lógica de negocio y facilita las operaciones CRUD de manera rápida y segura, Hibernate y JPA para la persistencia en MySQL, y React en el frontend, el sistema permite realizar operaciones esenciales de Crear, Leer, Actualizar y Eliminar usuarios de manera intuitiva y ágil.",
    repositories: {
